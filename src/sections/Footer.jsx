  ...
  return (
    <footer className="bg-slate-300 dark:bg-indigoIron-700 py-6">
      <div className="max-w-6xl mx-auto font-[sans-serif] text-black dark:text-white ">
        ...
        <div className="grid lg:grid-cols-3 items-center gap-4 lg:pr-2 lg:pt-2 lg:pb-2 lg:pl-7 shadow-sm  rounded-lg mt-8  bg-indigoIron-800">
            ...
            <ul className="mt-8 space-y-8">
              <li className="flex items-center max-lg:justify-center">
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <circle cx="10" cy="7" r="6" data-original="#fff"></circle>
                  <path
                    d="M14 15H6a5 5 0 0 0-5 5 3 3 0 0 0 3 3h12a3 3 0 0 0 3-3 5 5 0 0 0-5-5zm8-4h-2.59l.3"
              ...
              <li className="flex items-center max-lg:justify-center">
                ...
                <a
                  ...
                  className="text-white text-sm ml-3"
                >
                  <strong>jesse.j.little@gmail.com</strong>
                </a>
              </li>
              <li className="flex items-center max-lg:justify-center">
                <svg
                ...
                <a
                  ...
                  className="text-white text-sm ml-3"
                >
                  <strong>512-927-6287</strong>
                </a>
              </li>
            </ul>
            <ul className="flex max-lg:justify-center mt-16 space-x-4">
              <li className="bg-gray-800 hover:bg-gray-700 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
